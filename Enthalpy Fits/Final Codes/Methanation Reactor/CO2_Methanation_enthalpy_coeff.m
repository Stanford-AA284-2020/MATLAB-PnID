function x = CO2_Methanation_enthalpy_coeff()
%% The function returns coefficients for the best fit to CO2 Methanation's heat of reaction
...
title('CO2 Methanation Enthalpy of Reaction fit');
plotfixer;
end