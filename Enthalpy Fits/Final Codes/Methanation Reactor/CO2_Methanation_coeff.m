function x = CO2_Methanation_coeff()
%% The function returns coefficients for the best fit to CO2 Methanation equilbirum constant
...
hold on;
plot(Temp, Kp, 'b-');
xlabel('Temperature (K)'); ylabel('Heat of reaction (Kp)');
title('CO2 Methanation Kp fit');
