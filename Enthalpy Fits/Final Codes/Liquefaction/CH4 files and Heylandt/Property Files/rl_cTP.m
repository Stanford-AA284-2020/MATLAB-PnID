function r = rl_cTP(c,T,P,varargin)
% Return the liquid density (kg/m3) for any given T (K) and P (Pa).
% C.F. Edwards, 2-16-10

% If an additional arguments is specified it is starting density (kg/m3).
...
if(j == jmax)
    disp('Backtrack not successfull in rl_cTP')
end
