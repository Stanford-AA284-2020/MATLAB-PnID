function dmuidci = dmuidci_icrT(i,c,r,T)
...
if(c(i) < cinc)                             % Use a forward difference.
    clow = c;
    glow = mui_icrT(i,clow,r,T);            % Chemical potential function.
    ...
    gmid = mui_icrT(i,cmid,r,T);            % Chemical potential function.  
